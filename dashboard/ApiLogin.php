...
$sql = "SELECT email_patient,nom_patient,prenom_patient,telephone_patient,password_patient,id_patient  FROM patient
WHERE email_patient='$email' AND password_patient='$password';";
